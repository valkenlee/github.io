const TRANSLATIONS = {
    ko: {
        ...
        descriptions: {
			...
			discard: "📌 <b>🀄 무엇을 버릴까? 모드:</b><br>• 14장의 손패(13장 + 새로 가져온 쯔모패)에서 버렸을 때 텐파이가 되며, 대기패의 매수가 가장 많은 <b>최선의 버림패</b>를 선택하는 모드입니다.<br>• 제출 후 버림패별 대기패 목록 및 수량 분석 리포트를 제공합니다."
        },
    ...
    ja: {
        ...
        quizInstruction_best: "アガリ牌となる数字を1つだけ選んでください:",
        ...
        descriptions: {
			...
			discard: "📌 <b>🀄 何を捨てる？モード:</b><br>• 14枚の手牌（13枚 +ツモ牌）から捨てた時にテンパイになり、待ち牌の枚数が最も多い最善の切牌を選択するモードです。<br>• 提出後、切牌ごとの待ち牌一覧および枚数分析レポートを提供します。"
        },
    ...
    zh_CN: {
        ...
        descriptions: {
			...
			discard: "📌<b> 🀄 打什么？模式：</b><br>• 从14张手牌（13张 + 摸到的牌）中打出牌后达成听牌，并选择听牌张数最多的最佳打牌模式。<br>• 提交后提供按打牌分类的听牌列表及张数分析报告。"
    ...
    zh_TW: {
        ...
        descriptions: {
			...
			discard: "📌 <b>🀄 打什麼？模式：</b><br>• 從14張手牌（13張 + 摸到的牌）中打出牌後達成聽牌，並選擇聽牌張數最多的最佳打牌模式。<br>• 提交後提供按打牌分類的聽牌列表及張數分析報告。"			
        },
        yaku: {
            chinitsu: "清一色",
            reach: "立直",
    ...
    en: {
        ...
        descriptions: {
			...
			discard: "📌<b> 🀄 What to Discard? Mode:</b><br>• Select the best discard tile that achieves Tenpai and offers the highest number of waiting tiles from a 14-tile hand (13 hand tiles + 1 drawn tile).<br>• A waiting tile list and quantity analysis report for each discard will be provided after submission."
        },
